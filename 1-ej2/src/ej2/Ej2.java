...
Escribir una función que tome como parámetro el arreglo y devuelva la posición del elemento más grande del arreglo. 
Imprimir por pantalla el mayor de los elementos del arreglo.
 */
package ej2;
...
public class Ej2 {
    public static void main(String[] args)
    {
        ...
        System.out.println("El menor numero es: "+Ej2.menor(array));
    }
